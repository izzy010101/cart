...
console.log(imageStore.loadCartLocalStorage());
  ...
  <div class="flex flex-col gap-10 bg-[#f9fafb]">
    ...
    <ul v-if="!imageStore.isLocalStorageEmpty()" class="text-lg">
      ...
      >
        ...
        <button class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow" @click="imageStore.removeStorageItem('cart')">
          Remove
        </button>
      </li>
    </ul>
